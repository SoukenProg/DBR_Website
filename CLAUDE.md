...
System D.B.R. (Dual Blade Rhythm) のWebサイト - 音楽・ビジュアル制作サークルのポートフォリオサイト。Next.jsベースで、microCMSをヘッドレスCMSとして統合し、作品（音楽トラック）、イベント（即売会出展情報）、SNSリンクを管理します。
...
- `WorkCard.tsx` - 作品表示カード（プラットフォームリンク付き）
