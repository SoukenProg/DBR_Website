        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-8">
                ...
                >
                    ...
                    <div className="font-semibold text-gray-900 dark:text-white group-hover:text-accentBlue transition-colors">ホームページ</div>
                    <div className="text-sm text-gray-500 dark:text-gray-300 mt-1">トップページに戻る</div>
                </Link>
                ...
                >
                    <div className="text-4xl mb-2">🎵</div>
                    <div className="font-semibold text-gray-900 dark:text-white group-hover:text-accentRed transition-colors">作品一覧</div>
                    <div className="text-sm text-gray-500 dark:text-gray-300 mt-1">楽曲・制作物を見る</div>
                </Link>
                ...
                >
                    <div className="text-4xl mb-2">📅</div>
                    <div className="font-semibold text-gray-900 dark:text-white group-hover:text-accentGreen transition-colors">イベント情報</div>
                    <div className="text-sm text-gray-500 dark:text-gray-300 mt-1">出展イベントを見る</div>
                </Link>
                ...
                >
                    <div className="text-4xl mb-2">💬</div>
                    <div className="font-semibold text-gray-900 dark:text-white group-hover:text-accentBlue transition-colors">Discord</div>
                    <div className="text-sm text-gray-500 dark:text-gray-300 mt-1">コミュニティに参加</div>
                </Link>
            </div>

            {/* フッター */}
            <div className="text-center text-gray-500 dark:text-gray-400 text-sm mt-8 p-6 bg-gray-100 dark:bg-gray-900/50 rounded-lg border border-gray-200 dark:border-gray-800">
                <p>
