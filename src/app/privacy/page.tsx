    ...
    return (
        <div className="max-w-4xl mx-auto px-6 py-12">
            ...
            <div className="text-center mb-12">
                <h1 className="text-4xl md:text-5xl font-bold mb-4 text-gray-700 dark:text-gray-300 bg-gradient-to-r from-accentRed via-accentBlue to-accentGreen bg-clip-text text-transparent">
                    プライバシーポリシー
                </h1>
            ...
            <div className="bg-gradient-to-br from-accentBlue/10 to-accentRed/10 border border-accentBlue/30 rounded-lg p-8 mb-8">
                <h2 className="text-2xl font-bold mb-4 text-gray-700 dark:text-gray-300">お問い合わせ</h2>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
